...
`review:workflow` checks which local artifacts exist in a case folder and suggests the next safe commands. You can import `case-workflow-checklist.json` with the browser UI's `匯入 JSON` button.
