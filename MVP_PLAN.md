...
- 偵測 `.heic` / `.heif`
- 將 HEIC/HEIF 轉成官方可接受的 JPG 或 PNG 作為送件檔
...
- macOS 可先用 QuickLook 進行 HEIC 到 PNG 轉檔，避免 `sips` 在部分 HEIC 上輸出黑圖或 metadata-only JPG
