...
function usage() {
  console.log("Usage: node scripts/new-taipei-prototype.mjs <new-taipei-automation-plan.json> [--readiness-report case-readiness-report.json] [--plan-fixture-report new-taipei-plan-fixture-report.json] [--allow-network]");
  console.log("");
