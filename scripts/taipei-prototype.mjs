...
function usage() {
  console.log("Usage: node scripts/taipei-prototype.mjs <taipei-automation-plan.json> [--allow-network]");
  console.log("");
  console.log("Runs a guarded Taipei prototype preflight. It never submits, bypasses verification, or launches a browser unless --allow-network is provided.");
}
