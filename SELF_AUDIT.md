...
- `scripts/validate-case-draft.mjs` validates generated `draft.json` structure, attachment metadata, and saved review state without reading attachment contents or contacting official sites
...
- Verification confirmed `caseDraftValidationStatus: "ok"` for generated drafts and rejects invalid jurisdiction, attachment conversion status, `locationReview`, and `fieldReview` fixtures
